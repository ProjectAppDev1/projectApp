...
const createBranch = async (req, res) => {
    const newBranch = await branchesService.createBranch(req.params.id, req.body.name, req.body.longtitude, req.body.latitude);
    res.json(newBranch);
};
...
const editBranch = async (req, res) => {
    const branch = await branchesService.editBranch(req.params.id, req.body.name, req.body.longtitude, req.body.latitude);
    res.json(branch);
};
